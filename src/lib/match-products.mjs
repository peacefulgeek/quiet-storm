/**
 * match-products.mjs — Named-parameter product matcher
 * Used by cron scripts and server-side code.
 * Client-side code uses the existing findMatchingProducts in product-catalog.ts.
 */
